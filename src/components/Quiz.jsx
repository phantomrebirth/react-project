...
//                                     </p>
//                                 </div>
//                                 <Container className='answers-container' style={{padding: "0", margin: "0"}}>
//                                     <Row className='all-answers' style={{padding: "0", margin: "0"}}>
//                                         <div className='answer-container'>
//                                             <button className='answer' onClick={() => handleAnswerClick("A")}>
//                                                 A. Who
//                                             </button>
//                                         </div>
//                                         <div className='answer-container'>
//                                             <button className='answer' onClick={() => handleAnswerClick("B")}>
//                                                 B. What
//                                             </button>
//                                         </div>
//                                     </Row>
//                                     <Row className='all-answers' style={{padding: "0", margin: "0"}}>
//                                         <div className='answer-container'>
//                                             <button className='answer' onClick={() => handleAnswerClick("C")}>
//                                                 C. Where
//                                             </button>
//                                         </div>
//                                         <div className='answer-container'>
//                                             <button className='answer' onClick={() => handleAnswerClick("D")}>
//                                                 D. When
//                                             </button>
//                                         </div>
//                                     </Row>
